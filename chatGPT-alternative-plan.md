...
ER hints: Lesson 1‑* Sections 1‑* Slides 1‑* Blocks; Slide can contain many Blocks (ordered); Block optionally references Quiz.
...
```json
{
  "slide": {
    "layout": "two-column",
    "blocks": [
      { "type": "heading", "content": {"fr": "Le Mot Esprit — Définition", "en": "The Word Spirit — Definition"}, "order": 1 },
      { "type": "paragraph", "content": {"fr": "Le mot \"esprit\"…", "en": "The word 'spirit'…"}, "order": 2 },
      { "type": "callout", "content": {"fr": "La puissance de l'autorité du St‑Esprit…"}, "style": {"bg": "#FFF9C4"}, "order": 3 },
      { "type": "verse", "content": {"fr": "Jean 3:8"}, "order": 4 },
      { "type": "quiz", "content": {"fr": "Quelles qualités le Saint‑Esprit partage…?"}, "order": 5,
        "quiz": { "type": "mcq", "question": {"fr": "Quelles qualités…?"}, "choices": {"fr": ["Éternel", "Omniscient", "Aucun des deux"]}, "correctAnswers": [0,1] } }
    ]
  }
}
```
